 ...
 */
@interface XBMappingProvider : RKObjectMappingProvider
...
/**
 ...
 @return An initialized GHMappingProvider object
 */
+ (id)mappingProviderWithObjectStore:(RKManagedObjectStore *)objectStore;

/**
 Initialize an WPppingProvider with a RestKit managed object store object.
 
 @param objectStore The RKManagedObjectStore with which to initialize the mapping provider.
 @return An initialized GHMappingProvider instance.
 */
