...
@implementation XBArrayDataSourcePaginator {
    ...
    NSObject<XBArrayDataSource> *_dataSource;
}

+ (id)paginatorWithItemByPage:(NSUInteger)itemByPage dataSource:(NSObject<XBArrayDataSource> *)dataSource {
    return [[self alloc] initWithItemByPage:itemByPage dataSource:dataSource];
}

- (id)initWithItemByPage:(NSUInteger)itemByPage dataSource:(NSObject<XBArrayDataSource> *)dataSource {
    self = [super init];
    if (self) {
